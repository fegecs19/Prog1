...
void f1()
{
    cout << "Vector\n";
    vector<Item> vi;
    const string ifname = "chapter21.txt";
...
void f2()
{
    cout << "\nList\n";
    list<Item> li;
    const string ifname = "chapter21_2.txt";
    ...
    // 1.5 - use function instead of function object
    cout << "\n1.5: insert two items\n";
    li.insert(li.end(),Item("Terminator",200,1));
    li.insert(li.end(),Item("T3000",300,12));
    li.sort(comp_by_value);
    reverse(li.begin(),li.end());
    print(li.begin(),li.end());
    ...
    list<Item>::iterator li_it =
        find_if(li.begin(),li.end(),Find_by_name("T3000"));
    li.erase(li_it);
    li_it = find_if(li.begin(),li.end(),Find_by_name("Terminator"));
    li.erase(li_it);
    print(li.begin(),li.end());
    ...
    li.erase(li_it);
    li_it = find_if(li.begin(),li.end(),Find_by_iid(1));
    li.erase(li_it);
    print(li.begin(),li.end());
}
...
{
    // 3.1
    const string fname = "chapter21.txt";
